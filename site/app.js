...
const STRINGS = {
  en: {
    ...
    "ft.private.d": "Audio lives in memory for a fifth of a second, becomes 56 numbers, and is gone — nothing is recorded, nothing leaves the Mac. The only thing the app ever asks the internet is whether a newer version exists.",
  ...
  tr: {
    ...
    "ft.private.d": "Ses bellekte saniyenin beşte biri kadar yaşar, 56 sayıya dönüşür ve yok olur — hiçbir şey kaydedilmez, hiçbir şey Mac'ten çıkmaz. Uygulamanın internete sorduğu tek şey yeni sürüm olup olmadığı.",
